...
public class AddressBook {
     ...
     * used by the internal HashMap<PERSON_PROPERTY,String> storage format.
     * For example, a person's name is stored as the 0th element in the array.
     */
    private enum PERSON_PROPERTY {NAME,EMAIL,PHONE};
    ...
    /*
     * NOTE : =============================================================================================
     * Note that the type of the variable below can also be declared as List<HashMap<PERSON_PROPERTY,String>>, as follows:
     *    private static final List<HashMap<PERSON_PROPERTY,String>> ALL_PERSONS = new ArrayList<>()
     ...
     */
    private static final ArrayList<HashMap<PERSON_PROPERTY,String>> ALL_PERSONS = new ArrayList<>();
     ...
     */
    private static ArrayList<HashMap<PERSON_PROPERTY,String>> latestPersonListingView = getAllPersonsInAddressBook(); // initial view is of all
    ...
    private static String executeAddPerson(String commandArgs) {
        ...
        final Optional<HashMap<PERSON_PROPERTY,String>> decodeResult = decodePersonFromString(commandArgs);
        ...
        final HashMap<PERSON_PROPERTY,String> personToAdd = decodeResult.get();
     ...
     */
    private static String getMessageForSuccessfulAddPerson(HashMap<PERSON_PROPERTY,String> addedPerson) {
    ...
    private static String executeFindPersons(String commandArgs) {
        ...
        final ArrayList<HashMap<PERSON_PROPERTY,String>> personsFound = getPersonsWithNameContainingAnyKeyword(keywords);
     ...
     */
    private static String getMessageForPersonsDisplayedSummary(ArrayList<HashMap<PERSON_PROPERTY,String>> personsDisplayed) {
     ...
     */
    private static ArrayList<HashMap<PERSON_PROPERTY,String>> getPersonsWithNameContainingAnyKeyword(Collection<String> keywords) {
        final ArrayList<HashMap<PERSON_PROPERTY,String>> matchedPersons = new ArrayList<>();
        for (HashMap<PERSON_PROPERTY,String> person : getAllPersonsInAddressBook()) {
    ...
    private static String executeDeletePerson(String commandArgs) {
        boolean invalidInput = !isDeletePersonArgsValid(commandArgs);
        if (invalidInput) { //Guard Clause
            return getMessageForInvalidCommandInput(COMMAND_DELETE_WORD, getUsageInfoForDeleteCommand());
        }

        final int targetVisibleIndex = extractTargetIndexFromDeletePersonArgs(commandArgs);
        boolean invalidIndex = !isDisplayIndexValidForLastPersonListingView(targetVisibleIndex);

        if (invalidIndex) { //Guard Clause
            return MESSAGE_INVALID_PERSON_DISPLAYED_INDEX;
        }

        final HashMap<PERSON_PROPERTY,String> targetInModel = getPersonByLastVisibleIndex(targetVisibleIndex);
     ...
     */
    private static String getMessageForSuccessfulDelete(HashMap<PERSON_PROPERTY,String> deletedPerson) {
    ...
    private static String executeListAllPersonsInAddressBook() {
        ArrayList<HashMap<PERSON_PROPERTY,String>> toBeDisplayed = getAllPersonsInAddressBook();
        showToUser(toBeDisplayed);
        return getMessageForPersonsDisplayedSummary(toBeDisplayed);
    }

    private static String executeSortAllPersonsInAddressBook() {
        ArrayList<HashMap<PERSON_PROPERTY,String>> toBeDisplayed = sort(getAllPersonsInAddressBook());
        showToUser(toBeDisplayed);
        return getMessageForPersonsDisplayedSummary(toBeDisplayed);
    }

    private static ArrayList<HashMap<PERSON_PROPERTY,String>> sort(ArrayList<HashMap<PERSON_PROPERTY,String>> persons) {
        return persons;
    }
    ...
    */
     ...
     *
     */
    private static void showToUser(ArrayList<HashMap<PERSON_PROPERTY,String>> persons) {
     ...
     */
    private static String getDisplayString(ArrayList<HashMap<PERSON_PROPERTY,String>> persons) {
        final StringBuilder messageAccumulator = new StringBuilder();
        for (int i = 0; i < persons.size(); i++) {
            final HashMap<PERSON_PROPERTY,String> person = persons.get(i);
     ...
     */
    private static String getIndexedPersonListElementMessage(int visibleIndex, HashMap<PERSON_PROPERTY,String> person) {
     ...
     */
    private static String getMessageForFormattedPersonData(HashMap<PERSON_PROPERTY,String> person) {
     ...
     */
    private static void updateLatestViewedPersonListing(ArrayList<HashMap<PERSON_PROPERTY,String>> newListing) {
     ...
     */
    private static HashMap<PERSON_PROPERTY,String> getPersonByLastVisibleIndex(int lastVisibleIndex) {
     ...
     */
    private static ArrayList<HashMap<PERSON_PROPERTY,String>> loadPersonsFromFile(String filePath) {
        final Optional<ArrayList<HashMap<PERSON_PROPERTY,String>>> successfullyDecoded = decodePersonsFromStrings(getLinesInFile(filePath));
     ...
     */
    private static void savePersonsToFile(ArrayList<HashMap<PERSON_PROPERTY,String>> persons, String filePath) {
     ...
     * @param person to add
     */
    private static void addPersonToAddressBook(HashMap<PERSON_PROPERTY,String> person) {
     ...
     */
    private static boolean deletePersonFromAddressBook(HashMap<PERSON_PROPERTY,String> exactPerson) {
     ...
     */
    private static ArrayList<HashMap<PERSON_PROPERTY,String>> getAllPersonsInAddressBook() {
        return ALL_PERSONS;
    }
     ...
     */
    private static void initialiseAddressBookModel(ArrayList<HashMap<PERSON_PROPERTY,String>> persons) {
        ALL_PERSONS.clear();
     ...
     */
    private static String getNameFromPerson(HashMap<PERSON_PROPERTY,String> person) {
        return person.get(PERSON_PROPERTY.NAME);
    }
     ...
     */
    private static String getPhoneFromPerson(HashMap<PERSON_PROPERTY,String> person) {
        return person.get(PERSON_PROPERTY.PHONE);
    }
     ...
     */
    private static String getEmailFromPerson(HashMap<PERSON_PROPERTY,String> person) {
        return person.get(PERSON_PROPERTY.EMAIL);
    }
     ...
     */
    private static HashMap<PERSON_PROPERTY,String> makePersonFromData(String name, String phone, String email) {
        final HashMap<PERSON_PROPERTY,String> person = new HashMap<>();
        person.put(PERSON_PROPERTY.NAME,name);
        person.put(PERSON_PROPERTY.PHONE,phone);
        person.put(PERSON_PROPERTY.EMAIL,email);
        return person;
    }
     ...
     */
    private static String encodePersonToString(HashMap<PERSON_PROPERTY,String> person) {
     ...
     */
    private static ArrayList<String> encodePersonsToStrings(ArrayList<HashMap<PERSON_PROPERTY,String>> persons) {
        final ArrayList<String> encoded = new ArrayList<>();
        for (HashMap<PERSON_PROPERTY,String> person : persons) {
     ...
     */
    private static Optional<HashMap<PERSON_PROPERTY,String>> decodePersonFromString(String encoded) {
        // check that we can extract the parts of a person from the encoded string
        if (!isPersonDataExtractableFrom(encoded)) {
            return Optional.empty();
        }

        final HashMap<PERSON_PROPERTY,String> decodedPerson = makePersonFromData(
     ...
     */
    private static Optional<ArrayList<HashMap<PERSON_PROPERTY,String>>> decodePersonsFromStrings(ArrayList<String> encodedPersons) {
        final ArrayList<HashMap<PERSON_PROPERTY,String>> decodedPersons = new ArrayList<>();
        for (String encodedPerson : encodedPersons) {
            final Optional<HashMap<PERSON_PROPERTY,String>> decodedPerson = decodePersonFromString(encodedPerson);
     ...
     */
    private static boolean isPersonDataValid(HashMap<PERSON_PROPERTY,String> person) {
        return isPersonNameValid(person.get(PERSON_PROPERTY.NAME))
                && isPersonPhoneValid(person.get(PERSON_PROPERTY.PHONE))
                && isPersonEmailValid(person.get(PERSON_PROPERTY.EMAIL));
    }
